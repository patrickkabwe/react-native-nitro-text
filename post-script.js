...
const androidWorkaround = async () => {
 ...
 const viewManagerFile = path.join(
   process.cwd(),
   'nitrogen/generated/android/kotlin/com/margelo/nitro/nitrotext/views',
   'HybridNitroTextManager.kt'
 )

 const viewManagerStr = await readFile(viewManagerFile, { encoding: 'utf8' })
 await writeFile(viewManagerFile, viewManagerStr.replace(/com\.margelo\.nitro\.nitrotext\.\*/g, 'com.nitrotext.*'))
