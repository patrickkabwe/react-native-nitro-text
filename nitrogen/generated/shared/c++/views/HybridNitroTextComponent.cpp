...
namespace margelo::nitro::nitrotext::views {
  ...
  HybridNitroTextProps::HybridNitroTextProps(const react::PropsParserContext& context,
    ...
    onTextLayout([&]() -> CachedProp<std::optional<std::function<void(const TextLayoutEvent& /* layout */)>>> {
      try {
        ...
        const auto& [runtime, value] = (std::pair<jsi::Runtime*, jsi::Value>)*rawValue;
        return CachedProp<std::optional<std::function<void(const TextLayoutEvent& /* layout */)>>>::fromRawValue(*runtime, value.asObject(*runtime).getProperty(*runtime, PropNameIDCache::get(*runtime, "f")), sourceProps.onTextLayout);
      } catch (const std::exception& exc) {
    ...
    onPress([&]() -> CachedProp<std::optional<std::function<void()>>> {
      try {
        ...
        const auto& [runtime, value] = (std::pair<jsi::Runtime*, jsi::Value>)*rawValue;
        return CachedProp<std::optional<std::function<void()>>>::fromRawValue(*runtime, value.asObject(*runtime).getProperty(*runtime, PropNameIDCache::get(*runtime, "f")), sourceProps.onPress);
      } catch (const std::exception& exc) {
    ...
    onPressIn([&]() -> CachedProp<std::optional<std::function<void()>>> {
      try {
        ...
        const auto& [runtime, value] = (std::pair<jsi::Runtime*, jsi::Value>)*rawValue;
        return CachedProp<std::optional<std::function<void()>>>::fromRawValue(*runtime, value.asObject(*runtime).getProperty(*runtime, PropNameIDCache::get(*runtime, "f")), sourceProps.onPressIn);
      } catch (const std::exception& exc) {
    ...
    onPressOut([&]() -> CachedProp<std::optional<std::function<void()>>> {
      try {
        ...
        const auto& [runtime, value] = (std::pair<jsi::Runtime*, jsi::Value>)*rawValue;
        return CachedProp<std::optional<std::function<void()>>>::fromRawValue(*runtime, value.asObject(*runtime).getProperty(*runtime, PropNameIDCache::get(*runtime, "f")), sourceProps.onPressOut);
      } catch (const std::exception& exc) {
    ...
    hybridRef([&]() -> CachedProp<std::optional<std::function<void(const std::shared_ptr<HybridNitroTextSpec>& /* ref */)>>> {
      try {
        ...
        const auto& [runtime, value] = (std::pair<jsi::Runtime*, jsi::Value>)*rawValue;
        return CachedProp<std::optional<std::function<void(const std::shared_ptr<HybridNitroTextSpec>& /* ref */)>>>::fromRawValue(*runtime, value.asObject(*runtime).getProperty(*runtime, PropNameIDCache::get(*runtime, "f")), sourceProps.hybridRef);
      } catch (const std::exception& exc) {
  ...
  void HybridNitroTextComponentDescriptor::adopt(react::ShadowNode& shadowNode) const {
    ...
    auto& concreteShadowNode = static_cast<HybridNitroTextShadowNode&>(shadowNode);
    const std::shared_ptr<const HybridNitroTextProps>& constProps = concreteShadowNode.getConcreteSharedProps();
    const std::shared_ptr<HybridNitroTextProps>& props = std::const_pointer_cast<HybridNitroTextProps>(constProps);
    HybridNitroTextState state{props};
