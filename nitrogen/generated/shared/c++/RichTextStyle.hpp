...
namespace margelo::nitro::nitrotext {
  ...
  /**
   * A struct which can be represented as a JavaScript object (RichTextStyle).
   */
  ...
  public:
    ...
    std::optional<double> marginTop     SWIFT_PRIVATE;
    std::optional<double> marginBottom     SWIFT_PRIVATE;
    std::optional<double> marginLeft     SWIFT_PRIVATE;
    std::optional<double> marginRight     SWIFT_PRIVATE;

  public:
    RichTextStyle() = default;
    explicit RichTextStyle(std::optional<std::string> fontColor, std::optional<std::string> fragmentBackgroundColor, std::optional<double> fontSize, std::optional<FontWeight> fontWeight, std::optional<FontStyle> fontStyle, std::optional<std::string> fontFamily, std::optional<double> lineHeight, std::optional<double> letterSpacing, std::optional<TextAlign> textAlign, std::optional<TextTransform> textTransform, std::optional<TextDecorationLine> textDecorationLine, std::optional<std::string> textDecorationColor, std::optional<TextDecorationStyle> textDecorationStyle, std::optional<double> marginTop, std::optional<double> marginBottom, std::optional<double> marginLeft, std::optional<double> marginRight): fontColor(fontColor), fragmentBackgroundColor(fragmentBackgroundColor), fontSize(fontSize), fontWeight(fontWeight), fontStyle(fontStyle), fontFamily(fontFamily), lineHeight(lineHeight), letterSpacing(letterSpacing), textAlign(textAlign), textTransform(textTransform), textDecorationLine(textDecorationLine), textDecorationColor(textDecorationColor), textDecorationStyle(textDecorationStyle), marginTop(marginTop), marginBottom(marginBottom), marginLeft(marginLeft), marginRight(marginRight) {}
  };
...
namespace margelo::nitro {
  ...
  // C++ RichTextStyle <> JS RichTextStyle (object)
  template <>
  struct JSIConverter<margelo::nitro::nitrotext::RichTextStyle> final {
    static inline margelo::nitro::nitrotext::RichTextStyle fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrotext::RichTextStyle(
        ...
        JSIConverter<std::optional<double>>::fromJSI(runtime, obj.getProperty(runtime, "marginTop")),
        JSIConverter<std::optional<double>>::fromJSI(runtime, obj.getProperty(runtime, "marginBottom")),
        JSIConverter<std::optional<double>>::fromJSI(runtime, obj.getProperty(runtime, "marginLeft")),
        JSIConverter<std::optional<double>>::fromJSI(runtime, obj.getProperty(runtime, "marginRight"))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrotext::RichTextStyle& arg) {
      ...
      obj.setProperty(runtime, "marginTop", JSIConverter<std::optional<double>>::toJSI(runtime, arg.marginTop));
      obj.setProperty(runtime, "marginBottom", JSIConverter<std::optional<double>>::toJSI(runtime, arg.marginBottom));
      obj.setProperty(runtime, "marginLeft", JSIConverter<std::optional<double>>::toJSI(runtime, arg.marginLeft));
      obj.setProperty(runtime, "marginRight", JSIConverter<std::optional<double>>::toJSI(runtime, arg.marginRight));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<std::optional<double>>::canConvert(runtime, obj.getProperty(runtime, "marginTop"))) return false;
      if (!JSIConverter<std::optional<double>>::canConvert(runtime, obj.getProperty(runtime, "marginBottom"))) return false;
      if (!JSIConverter<std::optional<double>>::canConvert(runtime, obj.getProperty(runtime, "marginLeft"))) return false;
      if (!JSIConverter<std::optional<double>>::canConvert(runtime, obj.getProperty(runtime, "marginRight"))) return false;
      return true;
    }
  };
