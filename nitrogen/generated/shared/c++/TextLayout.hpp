...
namespace margelo::nitro::nitrotext {
  ...
  public:
    friend bool operator==(const TextLayout& lhs, const TextLayout& rhs) = default;
  };
  ...
  struct JSIConverter<margelo::nitro::nitrotext::TextLayout> final {
    static inline margelo::nitro::nitrotext::TextLayout fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      return margelo::nitro::nitrotext::TextLayout(
        ...
        JSIConverter<double>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "descender"))),
        JSIConverter<double>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "capHeight"))),
        JSIConverter<double>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "ascender"))),
        JSIConverter<double>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "xHeight")))
      );
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrotext::TextLayout& arg) {
      ...
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "descender"), JSIConverter<double>::toJSI(runtime, arg.descender));
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "capHeight"), JSIConverter<double>::toJSI(runtime, arg.capHeight));
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "ascender"), JSIConverter<double>::toJSI(runtime, arg.ascender));
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "xHeight"), JSIConverter<double>::toJSI(runtime, arg.xHeight));
      return obj;
    }
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<double>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "descender")))) return false;
      if (!JSIConverter<double>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "capHeight")))) return false;
      if (!JSIConverter<double>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "ascender")))) return false;
      if (!JSIConverter<double>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "xHeight")))) return false;
      return true;
    }
  };
