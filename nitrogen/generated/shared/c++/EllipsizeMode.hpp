///
/// EllipsizeMode.hpp
/// This file was added to extend NitroText with ellipsizeMode support.
/// Mirrors other generated enum headers.
///
...
namespace margelo::nitro::nitrotext {
  ...
  /**
   * Ellipsize mode for truncated text.
   */
