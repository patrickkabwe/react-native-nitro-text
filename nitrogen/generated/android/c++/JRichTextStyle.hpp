...
namespace margelo::nitro::nitrotext {
  ...
  /**
   * The C++ JNI bridge between the C++ struct "RichTextStyle" and the the Kotlin data class "RichTextStyle".
   */
  struct JRichTextStyle final: public jni::JavaClass<JRichTextStyle> {
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitrotext/RichTextStyle;";

  public:
    /**
     * Convert this Java/Kotlin-based struct to the C++ struct RichTextStyle by copying all values to C++.
     */
    [[maybe_unused]]
    [[nodiscard]]
    RichTextStyle toCpp() const {
      ...
      static const auto fieldMarginTop = clazz->getField<jni::JDouble>("marginTop");
      jni::local_ref<jni::JDouble> marginTop = this->getFieldValue(fieldMarginTop);
      static const auto fieldMarginBottom = clazz->getField<jni::JDouble>("marginBottom");
      jni::local_ref<jni::JDouble> marginBottom = this->getFieldValue(fieldMarginBottom);
      static const auto fieldMarginLeft = clazz->getField<jni::JDouble>("marginLeft");
      jni::local_ref<jni::JDouble> marginLeft = this->getFieldValue(fieldMarginLeft);
      static const auto fieldMarginRight = clazz->getField<jni::JDouble>("marginRight");
      jni::local_ref<jni::JDouble> marginRight = this->getFieldValue(fieldMarginRight);
      return RichTextStyle(
        ...
        marginTop != nullptr ? std::make_optional(marginTop->value()) : std::nullopt,
        marginBottom != nullptr ? std::make_optional(marginBottom->value()) : std::nullopt,
        marginLeft != nullptr ? std::make_optional(marginLeft->value()) : std::nullopt,
        marginRight != nullptr ? std::make_optional(marginRight->value()) : std::nullopt
      );
    }
  ...
  public:
     ...
     */
    [[maybe_unused]]
    static jni::local_ref<JRichTextStyle::javaobject> fromCpp(const RichTextStyle& value) {
      return newInstance(
        ...
        value.marginTop.has_value() ? jni::JDouble::valueOf(value.marginTop.value()) : nullptr,
        value.marginBottom.has_value() ? jni::JDouble::valueOf(value.marginBottom.value()) : nullptr,
        value.marginLeft.has_value() ? jni::JDouble::valueOf(value.marginLeft.value()) : nullptr,
        value.marginRight.has_value() ? jni::JDouble::valueOf(value.marginRight.value()) : nullptr
      );
    }
  };
