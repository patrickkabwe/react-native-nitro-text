...
public extension RichTextStyle {
  ...
  init(fontColor: String?, fragmentBackgroundColor: String?, fontSize: Double?, fontWeight: FontWeight?, fontStyle: FontStyle?, fontFamily: String?, lineHeight: Double?, letterSpacing: Double?, textAlign: TextAlign?, textTransform: TextTransform?, textDecorationLine: TextDecorationLine?, textDecorationColor: String?, textDecorationStyle: TextDecorationStyle?, marginTop: Double?, marginBottom: Double?, marginLeft: Double?, marginRight: Double?) {
    self.init({ () -> bridge.std__optional_std__string_ in
      ...
      if let __unwrappedValue = marginTop {
        return bridge.create_std__optional_double_(__unwrappedValue)
      } else {
        return .init()
      }
    }(), { () -> bridge.std__optional_double_ in
      if let __unwrappedValue = marginBottom {
        return bridge.create_std__optional_double_(__unwrappedValue)
      } else {
        return .init()
      }
    }(), { () -> bridge.std__optional_double_ in
      if let __unwrappedValue = marginLeft {
        return bridge.create_std__optional_double_(__unwrappedValue)
      } else {
        return .init()
      }
    }(), { () -> bridge.std__optional_double_ in
      if let __unwrappedValue = marginRight {
        return bridge.create_std__optional_double_(__unwrappedValue)
      } else {
        return .init()
      }
  ...
  var marginTop: Double? {
    @inline(__always)
    get {
      return self.__marginTop.value
    }
    @inline(__always)
    set {
      self.__marginTop = { () -> bridge.std__optional_double_ in
        if let __unwrappedValue = newValue {
          return bridge.create_std__optional_double_(__unwrappedValue)
        } else {
          return .init()
  ...
  var marginBottom: Double? {
    @inline(__always)
    get {
      return self.__marginBottom.value
    }
    @inline(__always)
    set {
      self.__marginBottom = { () -> bridge.std__optional_double_ in
        if let __unwrappedValue = newValue {
          return bridge.create_std__optional_double_(__unwrappedValue)
        } else {
          return .init()
  ...
  var marginLeft: Double? {
    @inline(__always)
    get {
      return self.__marginLeft.value
    }
    @inline(__always)
    set {
      self.__marginLeft = { () -> bridge.std__optional_double_ in
        if let __unwrappedValue = newValue {
          return bridge.create_std__optional_double_(__unwrappedValue)
        } else {
          return .init()
  ...
  var marginRight: Double? {
    @inline(__always)
    get {
      return self.__marginRight.value
    }
    @inline(__always)
    set {
      self.__marginRight = { () -> bridge.std__optional_double_ in
        if let __unwrappedValue = newValue {
          return bridge.create_std__optional_double_(__unwrappedValue)
        } else {
          return .init()
