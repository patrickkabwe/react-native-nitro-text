...
open class HybridNitroTextSpec_cxx {
   ...
   */
  @inline(__always)
  public func equals(other: HybridNitroTextSpec_cxx) -> Bool {
  ...
  public final var lineBreakStrategyIOS: bridge.std__optional_LineBreakStrategyIOS_ {
    @inline(__always)
    get {
      return { () -> bridge.std__optional_LineBreakStrategyIOS_ in
        if let __unwrappedValue = self.__implementation.lineBreakStrategyIOS {
    ...
    @inline(__always)
    set {
      self.__implementation.lineBreakStrategyIOS = newValue.value
    }
  }
  
  public final var dynamicTypeRamp: bridge.std__optional_DynamicTypeRamp_ {
    @inline(__always)
    get {
      return { () -> bridge.std__optional_DynamicTypeRamp_ in
        if let __unwrappedValue = self.__implementation.dynamicTypeRamp {
          return bridge.create_std__optional_DynamicTypeRamp_(__unwrappedValue)
        } else {
          return .init()
        }
      }()
    ...
    @inline(__always)
    set {
      self.__implementation.dynamicTypeRamp = newValue.value
    }
  }
